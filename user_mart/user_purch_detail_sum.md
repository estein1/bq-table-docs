---
id: user_purch_detail_sum
title: etsy-data-warehouse-prod.user_mart.user_purch_detail_sum
sidebar_label: user_purch_detail_sum
---

# user_purch_detail_sum

Detailed purchase summaries with product-level breakdowns

## Table Overview

**Full Table Name:** `etsy-data-warehouse-prod.user_mart.user_purch_detail_sum`
...
```sql
SELECT *
FROM `etsy-data-warehouse-prod.user_mart.user_purch_detail_sum`
