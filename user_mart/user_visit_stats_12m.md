---
id: user_visit_stats_12m
title: etsy-data-warehouse-prod.user_mart.user_visit_stats_12m
sidebar_label: user_visit_stats_12m
---

# user_visit_stats_12m

12-month rolling window user visit statistics

## Table Overview

**Full Table Name:** `etsy-data-warehouse-prod.user_mart.user_visit_stats_12m`
...
- Pre-aggregated visit statistics for past 12 months
...
SELECT
    ...
    top_browse_category,
    top_purch_category
FROM `etsy-data-warehouse-prod.user_mart.user_visit_stats_12m`
