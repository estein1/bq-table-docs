---
id: user_purch_stat_180d
title: etsy-data-warehouse-prod.user_mart.user_purch_stat_180d
sidebar_label: user_purch_stat_180d
---

# user_purch_stat_180d

180-day rolling window user purchase statistics

## Table Overview

**Full Table Name:** `etsy-data-warehouse-prod.user_mart.user_purch_stat_180d`
...
- Pre-aggregated purchase statistics for past 180 days
...
SELECT
    ...
    top_seller_user_id,
    purchase_days
FROM `etsy-data-warehouse-prod.user_mart.user_purch_stat_180d`
