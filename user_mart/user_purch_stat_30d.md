---
id: user_purch_stat_30d
title: etsy-data-warehouse-prod.user_mart.user_purch_stat_30d
sidebar_label: user_purch_stat_30d
---

# user_purch_stat_30d

30-day rolling window user purchase statistics

## Table Overview

**Full Table Name:** `etsy-data-warehouse-prod.user_mart.user_purch_stat_30d`
...
- Pre-aggregated purchase statistics for past 30 days
...
SELECT
    ...
    top_seller_user_id,
    purchase_days
FROM `etsy-data-warehouse-prod.user_mart.user_purch_stat_30d`
