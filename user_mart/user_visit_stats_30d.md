---
id: user_visit_stats_30d
title: etsy-data-warehouse-prod.user_mart.user_visit_stats_30d
sidebar_label: user_visit_stats_30d
---

# user_visit_stats_30d

30-day rolling window user visit statistics

## Table Overview

**Full Table Name:** `etsy-data-warehouse-prod.user_mart.user_visit_stats_30d`
...
- Pre-aggregated visit statistics for past 30 days
...
SELECT
    ...
    top_browse_category,
    top_purch_category
FROM `etsy-data-warehouse-prod.user_mart.user_visit_stats_30d`
