---
id: user_visit_stats_180d
title: etsy-data-warehouse-prod.user_mart.user_visit_stats_180d
sidebar_label: user_visit_stats_180d
---

# user_visit_stats_180d

180-day rolling window user visit statistics

## Table Overview

**Full Table Name:** `etsy-data-warehouse-prod.user_mart.user_visit_stats_180d`
...
- Pre-aggregated visit statistics for past 180 days
...
SELECT
    ...
    top_browse_category,
    top_purch_category
FROM `etsy-data-warehouse-prod.user_mart.user_visit_stats_180d`
